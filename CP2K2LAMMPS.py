...
with open("cif.cif","r") as cif_file:
    ...
    A_length = re.search(r"_cell_length_a",r)
    B_length = re.search(r"_cell_length_b",r)
    C_length = re.search(r"_cell_length_c",r)
    alpha_angle = re.search(r"_cell_angle_alpha",r)
    beta_angle = re.search(r"_cell_angle_beta",r)
    gamma_angle = re.search(r"_cell_angle_gamma",r)

# Create new .inp file for CP2K: 

w = inp_file.writelines
